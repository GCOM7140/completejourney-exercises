...
**Question 2**: As Hadley and Garrett outline in [Chapter 7], EDA is an
iterative cycle. Suppose that based on what you learned in Question 1, you want
to know what the median spend per individual is for different household sizes.
How could you plot median spend per individual by household size to answer this
new question with a visualization?
