...
# Quantity of 0 counted alone and other quantity numbers are null. 

# Question 2: 
# Use a line graph to plot total sales value by date. What, if anything, do you find unusual about this visualization?

ggplot(data = transactions) +
  geom_line(mapping = aes(x = transaction_timestamp, y = sales_value))
# There are extreme large sales value in Feb, Mar and Oct 2017.
