...
**Answer**:
Of the 1,584 households that were mailed coupons as part of a campaign, only 
27.4% of redeemed a coupon.
...
**Answer**:
The most popular product bought with a campaign coupon is "YOGURT NOT MULTI-PACKS".
...
Here are some suggested steps: 
 ...
 4. Re-group by category and create an indicator of the first and last 
 week using `ifelse(row_number() == 1, 'first', 'last')`
 5. Unselect the `week_no` column and `spread()` the data to put the first and last columns 
...
**Answer**:
"FLUID MILK PRODUCTS" had a first to last week change of over 16x, making it the 
