...
# Question 1: Determine median weekly spend per individual (not household) using
...
# Question 3: Are baskets with diapers in them more likely than average to have
# beer in them, too? Legend has it that placing these two product categories
# closer together can increase beer sales (Powers 2002). Using the following
# starter code, calculate lift for the “association rule” that diapers in a
# basket (i.e., product_type == "BABY DIAPERS") imply that beer is in the basket
