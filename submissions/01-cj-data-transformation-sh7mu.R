...
# Q1 - Change the discount variables (i.e., retail_disc, coupon_disc,
...
# Q2 - Create three new variables named regular_price, loyalty_price, and coupon_price.
...
# Q3 - The transactions dataset includes 68,509 unique product IDs. How many of
# these products (not transactions!) had a regular price of one dollar or less?
# What does this count equal for loyalty price and coupon price?
...
# Q4 - What proportion of baskets are over $10 in sales value?
...
# Q5 - Which store with over $10K in total sales_value discounts its products
