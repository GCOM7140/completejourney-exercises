...
#' There doesn't seem to be a clear pattern between different household incomes. Private brands are around the same percentage of total spend across household income levels. 