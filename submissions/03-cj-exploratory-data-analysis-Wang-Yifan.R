...
inner_join(my_transaction_data, hh_demographic) %>% 
  distinct(household_key) %>% 
  nrow()
# From the result we can see that 2500 unique households exist in my_transaction_data, and 801 of these households have demographic data in hh_demographic.
