#' --- 
#' title: "complete journey exercise 4" 
...
# 27.4% of househoulds that receive coupons redeem at least one coupon. 
...
# 49% of coupons were redeemed at least once. 
...
# Select Beef had the most revenue growth (85.2% growth). 
