...
#'  The histogram is very distorted in terms of its axes. 
...
#' This scatterplot is very cyclical in nature, showing that some dates sales can be very high (before holidays), and some days sales can be very low. 
...
#' The most popular package sizes are the 18oz and 32oz. 
