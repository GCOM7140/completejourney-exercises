#Data Transformation Exercise - completejourney
#Yuansong(Kevin) Wu

install.packages("devtools")
devtools::install_github('GCOM7140/completejourney', 
                         auth_token = '851590f4418122bf507fd5c3d00698cc4dec9fcc')
library(dplyr)
library(tidyr)
...
transaction_data %>%
  ...
  select(retail_disc, coupon_disc, coupon_match_disc)
...
transaction_data %>%
  ...
  select(regular_price, loyalty_price, coupon_price)
