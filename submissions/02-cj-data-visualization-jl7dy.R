...
# Attributing all transactions as 'quantity 0'. X axis range is strange, going from 0 to 75000. Need to give ggplot some more direction.
...
# It is fairly cyclical most likely due to week trends or just seasonality. Lowest point around November and highest around Christmas.
