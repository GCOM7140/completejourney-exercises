...
#there is only count values displayed at zero quantity. Quantitiies aournd and after 25000 do not have count
...
#the sales value is very seasonal, reflecting the effects of holidays
